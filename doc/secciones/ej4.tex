...
Ademas todas las matrices del problema tienen sus elementos en $\mathbb{Z}$\textsubscript{100007}

\subsection{Formalizando}
Reformulando, dado un arreglo $A_1...A_n$ de con elementos en  $\mathbb{Z}^{3x3}_{100007}$, queremos ver si existen indices
i, j tal que:
\newline
j - i = L, y 
\newline
