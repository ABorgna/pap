...
Para probar la correctitud de dicho algoritmo, se decidió implementar un algoritmo con complejidad \bigo(R $\times$ D) donde para cada intervalo, hacemos dos pasadas lineales buscando el máximo y el segundo más grande. \newline
