...
\par{Volviendo a \quotes{historicos_contenidos}, para cada punto enemigo, chequeamos si está contenido. Si alguno está, retornamos -1. Luego para cada punto histórico distinto a los vértices, hacemos el mismo chequeo y sumamos cuántos están contenidos. Retornamos ese mismo valor.} \newline
